...
// Maps old App\Services\Ontology\Parsers\Handlers\JsonLdHandler to the new
// Youri\vandenBogert\Software\ParserJsonLd\JsonLdHandler class.
...
spl_autoload_register(function (string $class): void {
    ...
    $aliases = [
        'App\Services\Ontology\Parsers\Handlers\JsonLdHandler' => \Youri\vandenBogert\Software\ParserJsonLd\JsonLdHandler::class,
    ];
